...
public class PullToRefreshListView extends ListView implements OnScrollListener {
	...
	private void init(Context context) {
		...
		headView = (LinearLayout) inflater.inflate(layout.head, null);
		arrowImageView = (ImageView) headView.findViewById(id.head_arrowImageView);
		arrowImageView.setMinimumWidth(70);
		arrowImageView.setMinimumHeight(50);
		progressBar = (ProgressBar) headView.findViewById(id.head_progressBar);
		tipsTextview = (TextView) headView.findViewById(id.head_tipsTextView);
		lastUpdatedTextView = (TextView) headView.findViewById(id.head_lastUpdatedTextView);
...
//								+ "步后" + 2);
					...
					if (state == RELEASE_To_REFRESH) {
						state = REFRESHING;
//						Log.v("@@@@@@", "ACTION_UP RELEASE_To_REFRESH changeHeaderViewByState() " + "这是第  " + i++ + "步"
//								+ 3);
						changeHeaderViewByState();
						onRefresh();
//						Log.v("@@@@@@", "ACTION_UP RELEASE_To_REFRESH changeHeaderViewByState()" + " 这是第  " + i++ + "步"
...
//			Log.v("@@@@@@", "PULL_To_REFRESH 这是第  " + i++ + "步" + 13 + "  changeHeaderViewByState()");
		...
		case REFRESHING:
			...
			lastUpdatedTextView.setVisibility(View.VISIBLE);
//			Log.v("@@@@@@", "REFRESHING 这是第  " + i++ + "步" + "正在加载中 ...");
			break;
		case DONE:
			headView.setPadding(0, -1 * headContentHeight, 0, 0);
			progressBar.setVisibility(View.GONE);
			arrowImageView.clearAnimation();
			arrowImageView.setImageResource(drawable.arrow);
...
//			Log.v("@@@@@@", "DONE 这是第  " + i++ + "步" + "已经加载完毕- DONE ");
	...
	public void onRefreshComplete() {
		state = DONE;
		lastUpdatedTextView.setText("上次刷新: " + DateFormat.getDateTimeInstance().format(new Date()));
		changeHeaderViewByState();
