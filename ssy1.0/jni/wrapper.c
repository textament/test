...
void Java_com_zhubajie_client_utils_AudioRecordView_initEncoder(JNIEnv *env,
...
void Java_com_zhubajie_client_utils_AudioRecordView_destroyEncoder(
		JNIEnv *env, jobject jobj) {
	int res = lame_close(lame);
	LOGD("Deinit returned: %d", res);
}

void Java_com_zhubajie_client_utils_AudioRecordView_encodeFile(JNIEnv *env,
