 ...
 * 
 */
package com.shanshengyuan.client.model.statistics;
 ...
 *
 */
public class DishStatisticsRequest extends BaseRequest {
	...
	private Integer source;//事件来源 0.广告 1.列表 2.其他
	...
	public void setDk() {
		...
		if(source!=null){
			dkList.add("source:" + getSource());
		}
		
		if(dishId!=null){
			dkList.add("dishId:" + getDishId());
		}
