...
public class PullToRefreshListView extends ListView implements OnScrollListener {
    ...
    private HideShowListener listener;
    private int hideNumY;
	int i = 1;
    ...
    public void setHideShowListener(HideShowListener hideShowListener){
        listener = hideShowListener;
    }

	private void init(Context context) {

        listener = new HideShowListener() {
            @Override
...
//				Log.v("@@@@@@", tempY + "");
                if(hideNumY>tempY&&firstItemIndex>2){
                    listener.hideAction();
                }else if(hideNumY<tempY){
                    listener.showAction();
                }
